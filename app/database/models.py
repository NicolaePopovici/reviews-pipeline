...
class Country(Base):
    ...
    reviewers: Mapped[list["Reviewer"]] = relationship("Reviewer", back_populates="country")
...
class Reviewer(Base):
    ...
    country: Mapped["Country"] = relationship("Country", back_populates="reviewers")
...
class Review(Base):
    ...
    reviewer_id: Mapped[uuid.UUID] = mapped_column(ForeignKey('reviewers.id', ondelete="CASCADE"))
